...
const footerLinks = {
  Leistungen: [
    ...
    { label: 'Online-Shops',         href: '#pricing' },
...
export default function Footer() {
  return (
    <footer
      ...
      style={{ background: 'linear-gradient(180deg, #071510 0%, #040d09 100%)' }}
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <a
              ...
              className="inline-flex items-center mb-5 focus-visible:rounded"
            ...
            <p className="text-sm leading-relaxed mb-5 text-gray-500">
              Professionelle Websites für Kleinunternehmen im Schwarzwald und Freiburg. Verlässlich, modern, persönlich.
            </p>

            {/* Location */}
            <div className="flex items-center gap-2 text-sm text-gray-600 mb-5">
              <svg className="w-4 h-4 text-primary-700 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
            ...
            <div className="flex gap-3" aria-label="Soziale Netzwerke">
              {[
                ...
                <a
                  key={s.label}
                  href={s.href}
                  className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center hover:bg-primary-800 hover:text-white transition-colors focus-visible:rounded-lg"
                  aria-label={s.label}
                >
                  {s.icon}
                </a>
        ...
        {/* Bottom bar */}
        <div className="border-t border-white/5 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-600">
          <p>&copy; {new Date().getFullYear()} WebVilo. Alle Rechte vorbehalten.</p>
          <p>
            Gebaut mit Leidenschaft <span aria-label="Herz" role="img">♥</span> im Schwarzwald
          </p>
        </div>
      </div>
    </footer>

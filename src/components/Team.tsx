...
const team = [
  {
    ...
    bio: 'Full-Stack-Entwickler mit Leidenschaft für sauberen Code und nutzerzentriertes Design.',
    initials: 'NT',
  ...
  },
  {
    name: 'Mia Hoffmann',
    role: 'UI/UX Designer',
    bio: 'Gestaltet digitale Erlebnisse, die Nutzer begeistern – von der Wireframe-Skizze bis zum finalen Prototypen.',
    initials: 'MH',
  ...
  },
  {
    ...
    bio: 'Spezialist für skalierbare Architekturen, API-Design und Cloud-Deployment.',
    initials: 'LB',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 opacity-0" data-animate>
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600">
            Wir sind ein kleines, eingespieltes Team mit großer Leidenschaft für exzellente Software.
          </p>
        </div>
            ...
            >
              ...
              <div className={`relative h-48 bg-gradient-to-br ${member.color} flex items-center justify-center`}>
                <div className="w-24 h-24 rounded-full bg-white/20 backdrop-blur-sm border-4 border-white/30 flex items-center justify-center">
                  <span className="text-3xl font-bold text-white" aria-hidden="true">{member.initials}</span>
                </div>
                {/* Decorative blob */}
                <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-black/10 to-transparent" aria-hidden="true" />
              </div>
              ...
              <div className="p-6">
                ...
                {/* Social links */}
                <div className="flex items-center gap-3" aria-label={`Social links for ${member.name}`}>
                  <a
                    href={member.social.github}
                    className="flex items-center justify-center w-9 h-9 rounded-lg bg-gray-100 text-gray-500 hover:bg-primary-100 hover:text-primary-600 transition-colors focus-visible:rounded-lg"
